    ...
    return (
      <div className='app'>
        <a href='https://slack.com/oauth/authorize?scope=incoming-webhook,commands,bot&client_id=188005782946.189109978850'>
          <img src='img/add_to_slack.png' srcset='img/add_to_slack.png 1x, img/add_to_slack@2x.png 2x' alt='Add to Slack button' style={{margin: '0 auto', display: 'block'}} height='40' width='139'/>
        </a>
